 ...
 * @author Liao
 */
public class HashMapConverter extends BeanTypeBaseConverter{
	...
	public Object convert(Object value)throws BeanTypeConvertException{
		if(value==null){
		  ...
		  return newMap;
			...
			throw new BeanTypeConvertException("Doesn't support object conversion from type: "+ value.getClass().getName() + " to type:"+HashMap.class.getName());
		}
	}
}
